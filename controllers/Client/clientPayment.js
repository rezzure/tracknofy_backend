...
// const path = require("path");
// const User = require("../../Schema/users.schema/users.model"); // Make sure this path is correct
// const Payments = require("../../Schema/recivedPayments.Schema/payment.model");
// const fs = require('fs');
...
//     try {
//         // Find client user by name and role
...
//             return res.status(404).json({
//                 success: false,
//                 message: 'Client user not found or user is not a client'
//             });
//         }
...
//         // Note: Since we're using User schema instead of Client schema,
//         // you might need to update your logic for tracking payments.
//         // If you need to track payment totals in the User model, you'll need to add those fields.
//         // For now, I'll comment out the client update part since User schema doesn't have payment fields.
        
//         /*
//         // If you want to track payments in User schema, you'll need to add these fields to User model:

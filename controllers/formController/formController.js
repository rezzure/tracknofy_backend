...
exports.createForm = async (req, res) => {
  try {
    const { formName, formFields, createdBy } = req.body;
    const email = req.query.email
    console.log(email)
    ...
    // FIXED: Ensure measurement fields have proper defaults
    const processedFormFields = formFields.map(field => {
      if (field.type === 'measurement') {
        return {
          ...field,
          measurementType: field.measurementType || 'length',
          measurementUnit: field.measurementUnit || 'cm',
          allowUnitChange: field.allowUnitChange !== undefined ? field.allowUnitChange : true,
...
exports.updateForm = async (req, res) => {
  try {
    ...
    // FIXED: Process form fields to ensure measurement fields have proper defaults
    const processedFormFields = formFields.map(field => {
      if (field.type === 'measurement') {
        return {
          ...field,
...
exports.updateFormAlternative = async (req, res) => {
  try {
    ...
    form.formFields = processedFormFields;

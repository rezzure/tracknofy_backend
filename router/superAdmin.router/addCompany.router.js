...
const {addCompanies, getCompanies , updateCompanyStatus, updateCompany}= require("../../controllers/SuperAdmin/manageCompany");
...
// Routes
router.post('/add-company', upload.single('companyLogo'), addCompanies);
